...
A more engaging documentation can be found on [ERA Wiki](https://emergencyresponseafrica.atlassian.net/l/c/0UPidyFX)
...
Ensure to always create your service account and saving it in the `service-accounts/` folder as `service-account.json` when setting up this repo
...
```bash
aws cloudformation delete-stack --stack-name scratch
```
